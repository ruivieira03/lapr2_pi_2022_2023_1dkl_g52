...
public class AuthenticationUI implements Runnable {
    ...
    private List<MenuItem> getMenuItemForRoles() {
        ...
        rolesUI.add(new MenuItem(AuthenticationController.Roles.ADMINISTRATOR.name(), new AdminMenu()));
        rolesUI.add(new MenuItem(AuthenticationController.Roles.AGENT.name(), new AgentMenu()));
        rolesUI.add(new MenuItem(AuthenticationController.Roles.CLIENT.name(), new ClientMenu()));
        rolesUI.add(new MenuItem(AuthenticationController.Roles.NETWORK_MANAGER.name(), new NetworkManagerMenu()));
