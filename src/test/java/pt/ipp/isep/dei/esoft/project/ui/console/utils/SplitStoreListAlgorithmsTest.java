...
class SplitStoreListAlgorithmsTest {
    ...
    void splitStoreListInTwo() {
        ...
        List<List<StoreDTO>> lists = algorithm.splitStoreListInTwo(storeRepository.getSortedStoreList(),storeRepository.getSortedStoreList().size());
